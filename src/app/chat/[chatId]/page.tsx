...
export default function ChatPage() {
  ...
  const handleMediaSelected = async (
    ...
    if (!isImage && !isVideo) {
      alert("Solo podés enviar imágenes o videos.");
      return;
    }
  ...
  return (
    <main className="flex h-screen flex-col bg-black text-white">
      <div className="border-b border-white/10 bg-zinc-950 px-5 py-4">
        <h1 className="text-lg font-black">Chat anónimo</h1>
              ...
              >
                ...
                {!mine && (
                  <p className="mt-1 text-left text-[10px] font-bold text-zinc-700">
                    Tocá el mensaje para responder
                  </p>
                )}
              </div>
            );
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="flex gap-3">
            ...
            <input
              ...
              placeholder={recording ? "Grabando audio..." : replyingTo ? "Responder mensaje..." : "Mensaje anónimo..."}
              disabled={recording}
