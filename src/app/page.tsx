        ...
        <section className="mx-auto flex min-h-screen w-full max-w-md flex-col px-5 py-6 font-[Arial,Helvetica,sans-serif] tracking-[-0.015em]">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="mt-2 text-sm font-normal leading-6 tracking-[-0.025em] text-zinc-400">
                  Tocá Entrar anónimo para escribirle a quien quieras sin crear perfil.
                  Cada nuevo ingreso anónimo crea otra identidad.
                </p>
              </div>
            </div>
          ...
          <div className="mt-8 rounded-[2rem] border border-white/10 bg-[#111] p-6 shadow-[0_0_35px_rgba(255,255,255,0.025)]">
            ...
            <div className="mt-5 grid grid-cols-2 gap-3">
              <a href="/downloads/sayittome.apk" className="flex h-16 items-center justify-center rounded-full border border-white/10 bg-white/10 text-sm font-normal tracking-[-0.03em]">
                Android APK
              </a>
              <button className="flex h-16 items-center justify-center rounded-full border border-white/10 bg-white/10 text-sm font-normal tracking-[-0.03em]">
                iPhone
              </button>
            </div>
          </div>
    ...
    <main className="min-h-screen overflow-hidden bg-black text-white">
      <section className="mx-auto flex min-h-screen w-full max-w-6xl flex-col px-6 py-8">
        <header className="flex items-center justify-between">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.45em] text-fuchsia-300">SAYITTOME</p>
            <h1 className="mt-3 text-3xl font-semibold">Anónimo. Rápido. Real.</h1>
          </div>

          <div className="flex items-center gap-3">
            <Link href="/login" className="rounded-full bg-fuchsia-500/30 px-5 py-3 text-sm font-normal">Entrar</Link>
            <a href="/downloads/sayittome.apk" className="rounded-full bg-white/10 px-5 py-3 text-sm font-normal">Descargar APK</a>
            <UxModeSwitcher />
          </div>
        </header>
        ...
        <div className="grid flex-1 items-center gap-12 py-16 md:grid-cols-2">
          <div>
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <Link href="/register" className="rounded-full bg-white px-8 py-4 text-sm font-normal text-black">
                Crear perfil
              </Link>

              <Link href="/shuffle" className="rounded-full bg-fuchsia-500/30 px-8 py-4 text-sm font-normal">
                Ir al Shuffle
              </Link>

              <Link href="/shuffle" className="rounded-full bg-white/10 px-8 py-4 text-sm font-normal">
                Entrar anónimo
              </Link>
            </div>
          </div>
          ...
          <div className="relative mx-auto w-full max-w-sm">
            ...
            <div className="relative overflow-hidden rounded-[2.5rem] border border-fuchsia-500/20 bg-zinc-950 shadow-2xl shadow-fuchsia-950/40">
              ...
              <div className="-mt-16 px-6 pb-8">
                ...
                <p className="mt-3 text-sm leading-6 text-zinc-400">Perfil oscuro premium, historias, chats y anónimos en la nueva web real.</p>
              </div>
            </div>
          </div>
        </div>
