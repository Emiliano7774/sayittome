  ...
  return (
    <div
      className={[
        heightClass,
        variant === "landing"
          ? "bg-gradient-to-b from-violet-600 via-violet-950 to-black"
...
function DefaultAvatar({
  ...
  return (
    <div
      className={[
        "shrink-0 overflow-hidden rounded-full bg-gradient-to-br from-zinc-200 to-zinc-500 shadow-2xl",
        variant === "landing" ? "border-[3px] border-[#121212]" : "border-black",
        sizeClass,
      ].join(" ")}
    >
      {avatarUrl ? (
...
export default function ModernIdentityCard({
  ...
  const cardInner = (
    <div
      className={[
        ...
        variant === "landing"
          ? "rounded-[2rem] border border-violet-500/20 shadow-[0_0_90px_rgba(104,76,255,0.22)] md:rounded-[2.5rem]"
          : variant === "profile"
    ...
    >
      {variant === "shuffle" ? (
        <div className="relative flex aspect-[3/4] flex-col">
          <div className="relative flex flex-[1.55] flex-col">
            <CoverArea
        ...
        <>
          <CoverArea
            ...
            variant={variant}
          />
          <div className="relative bg-[#121212] px-6 pb-7 pt-16">
            <div className="absolute -top-14 left-6">
              {avatarSlot || <DefaultAvatar avatarUrl={avatarUrl} variant={variant} />}
            </div>
            <div className="min-h-[5.5rem] pl-[7.5rem]">
              <p className="text-2xl font-black">{handle}</p>
  ...
  return (
    <div className="relative mx-auto w-full max-w-sm">
      <div className="absolute -inset-8 rounded-[2.75rem] bg-violet-600/25 blur-3xl" />
