...
export default function BoostAccessGate({ state }: Props) {
  ...
  if (state === "guest") {
    return (
      <div className="mt-8 overflow-hidden rounded-[1.35rem] border border-orange-500/25 bg-gradient-to-br from-orange-500/10 via-[#120804] to-black p-6">
  ...
  return (
    <div className="mt-8 rounded-[1.35rem] border border-white/10 bg-white/[0.04] p-6">
