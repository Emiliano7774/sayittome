...
export default function ClassicAnonConnectCard() {
  ...
  return (
    <>
      <div
        className={`border-t border-white/[0.06] ${tokens.anonMt} ${tokens.anonPt} ${tokens.anonMb}`}
      >
        {isIncognitoVisitor ? (
          <>
            <div className={`flex items-center ${tokens.followingGap}`}>
              <Globe2
              ...
              />
              <p
                className={`font-semibold tracking-[-0.02em] text-white/88 ${tokens.anonTitle}`}
              >
            ...
            <p
              className={`mt-1.5 font-medium tracking-[-0.01em] text-white/42 ${tokens.anonBody} ${tokens.anonIndent}`}
            >
        ...
        <div
          className={`flex items-center ${tokens.followingGap} ${isIncognitoVisitor ? tokens.filterMt : ""}`}
        >
          {!isIncognitoVisitor ? (
            <Globe2
              size={tokens.anonIcon}
          ...
          <p
            className={`font-semibold tracking-[-0.02em] text-white/88 ${tokens.anonTitle} ${isIncognitoVisitor ? tokens.anonIndent : ""}`}
          >
            {cardTitle}
          </p>
        </div>
