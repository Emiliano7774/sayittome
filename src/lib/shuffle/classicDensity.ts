...
export type ClassicShuffleDensityTokens = {
  ...
  densityNumText: string;
  densityNumMinW: string;
  densityNumPad: string;
  densityTrackPad: string;
  onlineDot: number;
};
...
const DENSITY_TOKENS: Record<ClassicShuffleDensity, ClassicShuffleDensityTokens> = {
  5: {
    ...
    densityZoomIcon: 15,
    densityNumText: "text-[11px]",
    densityNumMinW: "min-w-[32px]",
    densityNumPad: "px-2 py-1",
    densityTrackPad: "p-1",
    onlineDot: 10,
  ...
  10: {
    ...
    densityZoomIcon: 13,
    densityNumText: "text-[10px]",
    densityNumMinW: "min-w-[28px]",
    densityNumPad: "px-1.5 py-1",
    densityTrackPad: "p-0.5",
    onlineDot: 9,
    followingGuestText: "text-[10px]",
    followingBtnText: "text-[10px]",
    followingBtnPx: "px-3",
    followingBtnPy: "py-1.5",
    anonIcon: 15,
    anonTitle: "text-[13px]",
  ...
  20: {
    ...
    densityZoomIcon: 12,
    densityNumText: "text-[9px]",
    densityNumMinW: "min-w-[24px]",
    densityNumPad: "px-1.5 py-0.5",
    densityTrackPad: "p-0.5",
    onlineDot: 7,
    followingGuestText: "text-[9px]",
    followingBtnText: "text-[9px]",
  ...
  30: {
    ...
    densityTrackPad: "p-0.5",
    onlineDot: 6,
    followingGuestText: "text-[8px]",
    followingBtnText: "text-[8px]",
    followingBtnPx: "px-2",
    followingBtnPy: "py-1",
    anonIcon: 12,
    anonTitle: "text-[11px]",
