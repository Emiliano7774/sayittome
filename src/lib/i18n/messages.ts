...
const es = {
  ...
  chats_mark_all_seen: "Marcar todos como vistos",
  chats_mark_all_seen_done: "Listo: sin pendientes",
  chats_mark_all_seen_partial: "Algunos chats no se pudieron marcar ({failed})",
  ...
  chats_delete_fail: "No se pudieron borrar los chats. Probá de nuevo.",
  ...
  web_promo_title: "También podés usar SayItToMe desde la web",
  web_promo_body: "Accedé desde cualquier dispositivo, sin instalar nada.",
  web_promo_cta: "Abrir versión web",
  web_promo_dismiss: "Cerrar aviso web",
  web_promo_region_label: "Versión web de SayItToMe",
  ...
  chat_block_profile: "Bloquear perfil",
  chat_unblock_profile: "Desbloquear perfil",
  chat_block_profile_success:
    "Perfil bloqueado. No podrá escribirte hasta que lo desbloquees o cambies de identidad.",
  chat_block_profile_fail: "No se pudo bloquear el perfil.",
  chat_unblock_profile_success: "Perfil desbloqueado.",
  chat_blocked_by_anon: "Este anónimo te bloqueó. No podés enviarle mensajes.",
  chat_camera_fail: "No se pudo abrir la cámara. Revisá permisos del navegador.",
  chat_gallery_fail: "No se pudo abrir la galería.",
  chat_media_permission_denied: "Necesitamos permiso de cámara o galería para enviar fotos y videos.",
  chat_mic_fail: "No se pudo activar el micrófono. Tocá de nuevo para reintentar.",
  chat_mic_permission_denied: "Necesitamos permiso de micrófono para grabar audio.",
  chat_mic_permission_blocked: "El micrófono quedó bloqueado. Activalo en Ajustes de la app.",
  chat_mic_open_settings: "Abrir Ajustes",
  chat_mic_slide_to_lock: "Deslizá hacia arriba para bloquear",
  chat_mic_locked: "Manos libres",
  chat_mic_stop_preview: "Detener",
  ...
  chat_delete_confirm_me: "El mensaje se ocultará solo para vos. La otra persona lo va a seguir viendo.",
  chat_delete_confirm_everyone: "El mensaje se reemplazará por “Mensaje eliminado” para todos y se quitarán los adjuntos.",
  chat_delete_confirm: "Eliminar",
  chat_delete_fail: "No se pudo eliminar el mensaje. Probá de nuevo.",
  ...
  admin_claim_bio: "Bio",
  admin_claim_reply_label: "Respuesta al reclamante",
  admin_claim_reply_placeholder: "Escribí la respuesta que verá la persona…",
  admin_claim_reply_send: "Enviar respuesta",
  admin_claim_reply_sending: "Enviando…",
  admin_claim_reply_fail: "No se pudo enviar la respuesta.",
  admin_claim_reply_sent_label: "Respuesta enviada",
  claim_admin_reply_title: "Respuesta de administración",
  claim_admin_reply_empty: "Todavía no hay respuesta de administración.",
  claim_reply_date: "Respondido el {date}",
  claim_reply_dismiss: "Ocultar aviso",
  profile_options: "Opciones del perfil",
  claim_history_menu: "Historial de reclamos",
  claim_history_title: "Historial de reclamos",
  claim_history_intro: "Tus mensajes a administración y sus respuestas.",
  claim_history_empty: "Todavía no enviaste ningún reclamo.",
  claim_history_error: "No se pudo cargar el historial.",
  claim_history_status_pending: "Pendiente",
  claim_history_status_replied: "Respondido",
  claim_history_status_reviewed: "Revisado",
  claim_history_status_dismissed: "Descartado",
  admin_undo_unban: "Quitar ban",
  admin_undo_unblur: "Quitar blur",
  admin_undo_clear_roleplay_tag: "Quitar marca de rol",
  admin_undo_clear_fake_profile_tag: "Quitar marca de perfil falso",
  ...
  admin_tag_fake_profile_fail: "No se pudo marcar el perfil falso.",
  admin_clear_fake_profile_tag_fail: "No se pudo quitar la marca de perfil falso.",
  ...
  story_reply_expired: "Historia",
  story_reply_fail: "No se pudo enviar la respuesta ({stage}:{code}).",
  story_reply_sending: "Enviando...",
  chat_notifications_label: "Notificaciones de mensajes",
  chat_notifications_menu: "Notificaciones",
  ...
  chat_notifications_enable_cta: "Permitir",
  chat_notifications_disable_cta: "Desactivar",
  chat_notifications_busy: "Activando...",
  chat_notifications_error: "No se pudieron activar las notificaciones.",
  chat_notifications_open_settings: "Abrir Ajustes",
  chat_notifications_token_on: "Token FCM: activo en este dispositivo",
  chat_notifications_token_off: "Token FCM: no registrado",
  ...
  chat_notifications_prompt_body:
    "Podemos avisarte cada vez que te llega un mensaje y mostrarte quién te lo envió. Después lo cambiás desde el menú ⋮ de tu perfil.",
...
const en: Record<keyof typeof es, string> = {
  ...
  chats_mark_all_seen: "Mark all as seen",
  chats_mark_all_seen_done: "Done: no pending chats",
  chats_mark_all_seen_partial: "Some chats could not be marked ({failed})",
  ...
  chats_delete_fail: "Could not delete the chats. Try again.",
  ...
  web_promo_title: "You can also use SayItToMe on the web",
  web_promo_body: "Open it from any device, with nothing to install.",
  web_promo_cta: "Open web version",
  web_promo_dismiss: "Dismiss web notice",
  web_promo_region_label: "SayItToMe web version",
  ...
  chat_block_profile: "Block profile",
  chat_unblock_profile: "Unblock profile",
  chat_block_profile_success:
    "Profile blocked. They cannot message you until you unblock or change identity.",
  chat_block_profile_fail: "Could not block the profile.",
  chat_unblock_profile_success: "Profile unblocked.",
  chat_blocked_by_anon: "This anonymous user blocked you. You cannot send messages.",
  chat_camera_fail: "Could not open the camera. Check browser permissions.",
  chat_gallery_fail: "Could not open the gallery.",
  chat_media_permission_denied: "Camera or gallery permission is required to send photos and videos.",
  chat_mic_fail: "Could not enable the microphone. Tap again to retry.",
  chat_mic_permission_denied: "Microphone permission is required to record audio.",
  chat_mic_permission_blocked: "Microphone access is blocked. Enable it in the app settings.",
  chat_mic_open_settings: "Open Settings",
  chat_mic_slide_to_lock: "Slide up to lock",
  chat_mic_locked: "Hands-free",
  chat_mic_stop_preview: "Stop",
  ...
  chat_delete_confirm_me: "The message will be hidden only for you. The other person will still see it.",
  chat_delete_confirm_everyone: "The message will be replaced with “Message deleted” for everyone and attachments will be removed.",
  chat_delete_confirm: "Delete",
  chat_delete_fail: "Could not delete the message. Try again.",
  ...
  admin_claim_shadowban: "Shadowban",
  admin_claim_bio: "Bio",
  admin_claim_reply_label: "Reply to claimant",
  admin_claim_reply_placeholder: "Write the reply the person will see…",
  admin_claim_reply_send: "Send reply",
  admin_claim_reply_sending: "Sending…",
  admin_claim_reply_fail: "Could not send the reply.",
  admin_claim_reply_sent_label: "Reply sent",
  claim_admin_reply_title: "Administration reply",
  claim_admin_reply_empty: "No administration reply yet.",
  claim_reply_date: "Replied on {date}",
  claim_reply_dismiss: "Hide notice",
  profile_options: "Profile options",
  claim_history_menu: "Claim history",
  claim_history_title: "Claim history",
  claim_history_intro: "Your messages to administration and their replies.",
  claim_history_empty: "You have not submitted any claims yet.",
  claim_history_error: "Could not load claim history.",
  claim_history_status_pending: "Pending",
  claim_history_status_replied: "Replied",
  claim_history_status_reviewed: "Reviewed",
  claim_history_status_dismissed: "Dismissed",
  admin_undo_unban: "Remove ban",
  admin_undo_unblur: "Remove blur",
  admin_undo_clear_roleplay_tag: "Remove roleplay tag",
  admin_undo_clear_fake_profile_tag: "Remove fake profile mark",
  ...
  admin_tag_fake_profile_fail: "Could not mark the fake profile.",
  admin_clear_fake_profile_tag_fail: "Could not remove the fake profile mark.",
  ...
  story_reply_expired: "Story",
  story_reply_fail: "Could not send the reply ({stage}:{code}).",
  story_reply_sending: "Sending...",
  chat_notifications_label: "Message notifications",
  chat_notifications_menu: "Notifications",
  ...
  chat_notifications_enable_cta: "Allow",
  chat_notifications_disable_cta: "Turn off",
  chat_notifications_busy: "Enabling...",
  chat_notifications_error: "Could not enable notifications.",
  chat_notifications_open_settings: "Open Settings",
  chat_notifications_token_on: "FCM token: active on this device",
  chat_notifications_token_off: "FCM token: not registered",
  ...
  chat_notifications_prompt_body:
    "We can notify you whenever a new message arrives and show who sent it. You can change this later from the ⋮ menu on your profile.",
...
const it: Record<keyof typeof es, string> = {
  ...
  web_promo_title: "Puoi usare SayItToMe anche sul web",
  web_promo_body: "Accedi da qualsiasi dispositivo, senza installare nulla.",
  web_promo_cta: "Apri versione web",
  web_promo_dismiss: "Chiudi avviso web",
  web_promo_region_label: "Versione web di SayItToMe",
...
const de: Record<keyof typeof es, string> = {
  ...
  web_promo_title: "SayItToMe kannst du auch im Web nutzen",
  web_promo_body: "Öffne es auf jedem Gerät, ohne etwas zu installieren.",
  web_promo_cta: "Webversion öffnen",
  web_promo_dismiss: "Web-Hinweis schließen",
  web_promo_region_label: "SayItToMe Webversion",
