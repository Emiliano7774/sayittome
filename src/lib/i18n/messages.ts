...
const es = {
  ...
  roleplay_appeal_title: "Reclamo sobre perfil de rol",
  roleplay_appeal_intro:
    "Tu perfil fue marcado como perfil de rol. Si querés explicar tu situación o enviar un reclamo, escribinos acá.",
  ...
  roleplay_appeal_message_placeholder: "Contanos tu reclamo con todo el detalle que necesites...",
  roleplay_appeal_message_required: "Escribí un mensaje para enviar el reclamo.",
  roleplay_appeal_photo_label: "Foto (opcional)",
  roleplay_appeal_submit: "Enviar reclamo",
  roleplay_appeal_sending: "Enviando...",
  roleplay_appeal_success: "Reclamo enviado. La administración lo revisará.",
  roleplay_appeal_fail: "No se pudo enviar el reclamo.",
  admin_appeal_title: "Reclamo de perfil de rol",
  ...
  admin_appeal_empty: "No hay reclamos de perfiles de rol.",
  ...
  admin_mod_tab_appeals: "Reclamos de rol",
...
const en: Record<keyof typeof es, string> = {
  ...
  roleplay_appeal_title: "Roleplay profile appeal",
  roleplay_appeal_intro:
    "Your profile was marked as a roleplay profile. If you want to explain your situation or send an appeal, write to us here.",
  roleplay_appeal_delay_note:
  ...
  roleplay_appeal_message_placeholder: "Tell us your appeal with as much detail as you need...",
  roleplay_appeal_message_required: "Write a message to send the appeal.",
  roleplay_appeal_photo_label: "Photo (optional)",
  roleplay_appeal_submit: "Send appeal",
  roleplay_appeal_sending: "Sending...",
  roleplay_appeal_success: "Appeal sent. Administration will review it.",
  roleplay_appeal_fail: "Could not send the appeal.",
  admin_appeal_title: "Roleplay profile appeal",
  admin_appeal_reporter: "Email",
  admin_appeal_photo: "Attached photo",
  admin_appeal_open_profile: "Open profile",
  admin_appeal_pending_count: "{count} pending",
  admin_appeal_empty: "No roleplay profile appeals.",
  ...
  admin_mod_tab_appeals: "Roleplay appeals",
  admin_mod_tab_chats: "Chats",
...
const it: Record<keyof typeof es, string> = {
  ...
  roleplay_appeal_title: "Reclamo profilo di ruolo",
  roleplay_appeal_intro:
    "Il tuo profilo è stato contrassegnato come profilo di ruolo. Se vuoi spiegare la tua situazione o inviare un reclamo, scrivici qui.",
  roleplay_appeal_delay_note:
  ...
  roleplay_appeal_message_placeholder: "Raccontaci il reclamo con tutti i dettagli che ti servono...",
  roleplay_appeal_message_required: "Scrivi un messaggio per inviare il reclamo.",
  roleplay_appeal_photo_label: "Foto (opzionale)",
  roleplay_appeal_submit: "Invia reclamo",
  roleplay_appeal_sending: "Invio...",
  roleplay_appeal_success: "Reclamo inviato. L'amministrazione lo revisionerà.",
  roleplay_appeal_fail: "Impossibile inviare il reclamo.",
  admin_mod_tab_appeals: "Reclami di ruolo",
  admin_appeal_title: "Reclamo profilo di ruolo",
  admin_appeal_reporter: "Email",
  admin_appeal_photo: "Foto allegata",
  admin_appeal_open_profile: "Apri profilo",
  admin_appeal_pending_count: "{count} in sospeso",
  admin_appeal_empty: "Nessun reclamo di profili di ruolo.",
...
const de: Record<keyof typeof es, string> = {
  ...
  roleplay_appeal_title: "Rollenprofil-Reklamation",
  roleplay_appeal_intro:
    "Dein Profil wurde als Rollenprofil markiert. Wenn du deine Situation erklären oder eine Reklamation senden möchtest, schreib uns hier.",
  roleplay_appeal_delay_note:
  ...
  roleplay_appeal_message_placeholder: "Beschreibe deine Reklamation mit allen Details...",
  roleplay_appeal_message_required: "Schreib eine Nachricht, um die Reklamation zu senden.",
  roleplay_appeal_photo_label: "Foto (optional)",
  roleplay_appeal_submit: "Reklamation senden",
  roleplay_appeal_sending: "Senden...",
  roleplay_appeal_success: "Reklamation gesendet. Die Administration prüft sie.",
  roleplay_appeal_fail: "Reklamation konnte nicht gesendet werden.",
  admin_mod_tab_appeals: "Rollen-Reklamationen",
  admin_appeal_title: "Rollenprofil-Reklamation",
  ...
  admin_appeal_empty: "Keine Rollenprofil-Reklamationen.",
