/**
 * Chrome native-shell soft-nav release 20/20 multi-source NO_SCREENCAST.
 */
...
const out = process.argv.includes("--out")
  ...
  : path.join(root, "scripts", "ghost-filmstrip-out", "local-chrome-native-shell-soft-nav-20");
...
console.log("CHROME_NATIVE_SHELL_SOFT_NAV_RELEASE_20");
